...
pub struct TpTcpStats {
    ...
    /// Full-flow payload byte totals per direction; downstream derives PCR from these.
    pub data_toserver: u64,
    pub data_toclient: u64,
...
pub extern "C" fn rs_tp_take_tcp_stats(flow_hash: u64, out: *mut TpTcpStats) -> u8 {
    ...
    unsafe {
        ...
        r.data_toserver        = flow.to_server.bytes;
        r.data_toclient        = flow.to_client.bytes;
